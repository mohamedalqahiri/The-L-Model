...
| $$\text{Einst}_t} = e^{\lambda(1 - f_t) + c}$$ | $\lambda : 0.3 \rightarrow 0$ | Institutional drag coefficient |
| $$\text{Dsec}_t = (1 - f_t) \cdot (\tau \cdot |2\rho - 1| + \mu \cdot {0.0425))| | Sectoral drag coefficient |
...
| $c =$ | $0.05$ | Policy impact // OECD |
| $\tau$ | $0.15$ | Size variance weight // World Bank Sector Data. |
| $\mu$ | $0.5$ | Growth variance weight // IMF Growth Reports |
| $\rho = \text{GDP\_h-tech} / \text{Total GDP}$ | $0.35$ | Relative high-tech sector volume // UNCTAD, BIS. |
| $\text{d.cagr}(t) = 0.07e^{-0.1t}$ | $7\% \sim 0$ | Sectors growth rate differential $d_{\text{cagr}}(t)$ // Calibrated on US, Germany, China data. |
