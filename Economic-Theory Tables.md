...
| $d_{\text{cagr}}(t) = \{\text{cagr\_h\_tech}(t) - \text{pri\_sec\_cagr}(t)\} = 0.07e^{-0.1t}$ | $7\% \sim 0$ | Sectors growth rate differential $d_{\text{cagr}}(t)$ // Calibrated on US, Germany, China data. |
